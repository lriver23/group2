...
@NoArgsConstructor
@RestController
@RequestMapping("/api/noauthentication")
@Tag(name = "NoAuthentication",description = "Allows manipulation of Authentication Data")
@Log4j2
public class NoAuthenticationService {
    @Autowired
    ...
    @ApiResponse(responseCode = "200", description = "valid response", 
        content = {@Content(mediaType="application/json", schema=@Schema(implementation=NoAuthentication.class))})
    ...
    public void save(@RequestBody NoAuthentication authentication){
    ...
    @ApiResponse(responseCode = "200", description = "valid response",
    content = {@Content(mediaType="application/json", schema=@Schema(implementation=NoAuthentication.class))})
    public ResponseEntity<String> put(@Valid @RequestBody NoAuthentication user) {
    ...
    public ResponseEntity<String> validatedSave(@Valid @RequestBody NoAuthentication authentication) {
